...
// Streamed.pk - https://streamed.pk/docs (live sports matches & streams)
export const STREAMED_API_BASE = 'https://streamed.pk/api'
export const STREAMED_BASE = 'https://streamed.pk'

// CDN-Live TV / StreamSports99 - https://streamsports99.su/api, https://api.cdn-live.tv
export const CDN_LIVE_API_BASE = 'https://api.cdn-live.tv/api/v1'
export const CDN_LIVE_PLAYER_BASE = 'https://cdn-live.tv/api/v1/channels/player'
export const CDN_LIVE_QUERY = 'user=cdnlivetv&plan=free'
